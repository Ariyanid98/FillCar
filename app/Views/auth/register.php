                    ...
                    <div class="col-lg">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h3 text-gray-900 mb-4"><center><?=lang('Auth.register')?></center></h1>
                            </div>

                            <?= view('Myth\Auth\Views\_message_block') ?>

                            <form action="<?= url_to('register') ?>" method="post"><?= csrf_field() ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user <?php if (session('errors.no.Handpghone')) : ?>is-invalid<?php endif ?>" name="no.Handphone"
                                        placeholder="<?=lang('Auth.no.Handphone')?>" value="<?= old('no.Handphone') ?>">
                                </div>
