    ...
    <div class="main">
        <div class="bg-hijau">
          <div class="d-flex align-items-center ml-4 pt-1">
            ...
            <p class="text-putih font-25 fub mt-1 p-1"> Inbox</p>
          </div>
        </div>
    </div>
    <br>
    ...
    <div class="sh-box mt-3">
      <div class="lokasi ml-2">
        <div class="lok align-items-center justify-center">
          <p class="text-hitam font-20 fub"> Siap-siap Keliling ?
          ...
          <p class="text-hitam font-12 fub"> Cek batrai dulu biar perjalanan anda tidak terganggu</p>
        </div>
      </div>
      <hr color="black">
      <div class="lokasi ml-2">
        <div class="lok align-items-center justify-center">
          <p class="text-hitam font-20 fub"> Yeay! Promonya berkali-kali
            <img class="iconify ml-5 mt-3" src="https://api.iconify.design/material-symbols/navigate-next.svg?color=%237c7171" style="float:right;">   
          </p>
          <p class="text-hitam font-12 fub"> Yuk,langganan FillCarUnlimited lagi!</p>
        </div>
      </div>
      <hr color="black">
      <div class="lokasi ml-2">
        <div class="lok align-items-center justify-center">
          <p class="text-hitam font-20 fub"> Siap-siap liburan akhir tahun!
            <img class="iconify ml-5 mt-3" src="https://api.iconify.design/material-symbols/navigate-next.svg?color=%237c7171" style="float:right;">
          </p>
          <p class="text-hitam font-12 fub"> Intip yuk sederet promo seru !</p>
        </div>
      </div>
      <hr color="black">
      <div class="lokasi">
        <div class="lok align-items-center justify-center">
          <p class="text-hitam font-20 fub"> Pelanggan setia FillCar
            <img class="iconify ml-5 mt-3" src="https://api.iconify.design/material-symbols/navigate-next.svg?color=%237c7171" style="float:right;">   
          </p>
          <p class="text-hitam font-12 fub">Nikmati promo yang dijamin HEMATTTTTT!</p>
        </div>
      </div>
    </div>
